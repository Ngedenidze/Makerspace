...
export default function Heading() {
  ...
  return (
      ...
      <section className="header-box">
        ...
        <section className="bar-info">
          <section className="footer-info">
            <a className="footer-links" href="https://www.google.com/maps?sca_esv=0c36c686c589dc21&output=search&q=makerspace+tbilisi&source=lnms">
              <h2>Location</h2>
   ...
   <svg   fill="currentColor"
            width="25px"
            height="25px" xmlns="http://www.w3.org/2000/svg"><g><path d="M0 0h24v24H0z" fill="none"/><path d="M4 15h2v5h12V4H6v5H4V3a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v18a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1v-6zm6-4V8l5 4-5 4v-3H2v-2h8z"/></g></svg>
        </a>
            </section>
