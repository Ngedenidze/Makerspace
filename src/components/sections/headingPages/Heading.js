    ...
    <>
      <section className="header-box">
        ...
        <section className="bar-info">
          ...
          <section className="translate-icon">
            <div>
              <svg
                fill="currentColor"
                xmlns="http://www.w3.org/2000/svg"
              ...
              <button onClick={() => switchLanguage('en')} className="lang-text">EN</button> <span>/</span>
<button onClick={() => switchLanguage('ka')} className="lang-text">GE</button> 
            </div>
